...
if [ "$1" == 'pc' ]; then
    ...
    execution  cut.json 1_dummy "$compiler" "$last_bin_dir" 50

    python gen.py 1 1 0 ./graphs/50k.json cut.json --mode 3 --shuffle_layers False --inside_layer_schedule backpack
    execution cut.json 1_depth "$compiler" "$last_bin_dir" 50
    python gen.py 2 1 0 ./graphs/50k.json cut.json --mode 3 --shuffle_layers False --inside_layer_schedule backpack
    execution cut.json 1_depth "$compiler" "$last_bin_dir" 50
    python gen.py 4 1 0 ./graphs/50k.json cut.json --mode 3 --shuffle_layers False --inside_layer_schedule backpack
    execution cut.json 1_depth "$compiler" "$last_bin_dir" 50

    python gen.py 1 1 0 ./graphs/600k.json cut.json --mode 1
    execution  cut.json 1_dummy "$compiler" "$last_bin_dir" 600

    python gen.py 1 1 0 ./graphs/600k.json cut.json --mode 3 --shuffle_layers False --inside_layer_schedule backpack
    execution cut.json 1_depth "$compiler" "$last_bin_dir" 600
    python gen.py 2 1 0 ./graphs/600k.json cut.json --mode 3 --shuffle_layers False --inside_layer_schedule backpack
    execution cut.json 1_depth "$compiler" "$last_bin_dir" 600
    python gen.py 4 1 0 ./graphs/600k.json cut.json --mode 3 --shuffle_layers False --inside_layer_schedule backpack
    execution cut.json 1_depth "$compiler" "$last_bin_dir" 600
