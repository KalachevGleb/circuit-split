...
def main():
    ...
    gen_simple_circuits([2**i for i in range(12, 18)], 5, [1, 2, 4, 8, 16])
    gen_simple_circuits([2**i for i in range(12, 18)], 10, [1, 2, 4, 8, 16])
    gen_simple_circuits([2**i for i in range(12, 18)], 15, [1, 2, 4, 8, 16])
    gen_simple_circuits([2**i for i in range(12, 18)], 20, [1, 2, 4, 8, 16])
