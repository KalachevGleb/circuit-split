...
def main():
    ...
    gen_simple_circuits([2**i for i in range(10, 17)], 5, [1, 2, 4, 8, 16])
    gen_simple_circuits([2**i for i in range(10, 17)], 10, [1, 2, 4, 8, 16])
    gen_simple_circuits([2**i for i in range(10, 17)], 15, [1, 2, 4, 8, 16])
    gen_simple_circuits([2**i for i in range(10, 17)], 20, [1, 2, 4, 8, 16])
