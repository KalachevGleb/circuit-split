...
def main():
    ...
    gen_simple_circuits([2**i for i in range(7, 18)], 5, [1, 2, 4])
    gen_simple_circuits([2**i for i in range(7, 18)], 10, [1, 2, 4])
    gen_simple_circuits([2**i for i in range(7, 18)], 15, [1, 2, 4])
    gen_simple_circuits([2**i for i in range(7, 18)], 20, [1, 2, 4])
